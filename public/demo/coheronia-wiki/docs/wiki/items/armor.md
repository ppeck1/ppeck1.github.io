...
![Armor](../../../art/generated/items/armor.png)
...
| Image path | `art/generated/items/armor.png` |
| Fallback / placeholder | Generated 16x16 swatch via `BlockRegistry.item_icon()` if the canonical item icon is absent. |

## Summary

Armor is a surrogate icon id used by the current UI rather than a real inventory or equipment entry.
