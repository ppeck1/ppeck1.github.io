...
Spores is a planned item hook. Referenced by planned Sporekin drops only.

## Acquisition

| Source type | Source | Quantity / chance | Notes |
|---|---|---|---|
| Enemy drop | [Sporekin](../enemies/sporekin.md) | 65% drop chance; planned only | Live acquisition only if the enemy is live. |
...
- Recommended first implementation sink: medicine, poison, or farming catalyst.
