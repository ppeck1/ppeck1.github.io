...
![Sword](../../../art/generated/items/sword.png)
...
| Image path | `art/generated/items/sword.png` |
| Fallback / placeholder | Generated 16x16 swatch via `BlockRegistry.item_icon()` if the canonical item icon is absent. |

## Summary

Sword is a surrogate icon id used by the current UI rather than a real inventory or equipment entry.
