...
Stone Plates is a planned item hook. Referenced by planned Stoneback Beetle drops only.

## Acquisition

| Source type | Source | Quantity / chance | Notes |
|---|---|---|---|
| Enemy drop | [Stoneback Beetle](../enemies/stoneback_beetle.md) | 80% drop chance; planned only | Live acquisition only if the enemy is live. |
...
- Recommended first implementation sink: armor or barricade plating.
