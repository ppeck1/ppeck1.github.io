...
Clay is a planned item hook. Referenced by planned Mudling drops only.

## Acquisition

| Source type | Source | Quantity / chance | Notes |
|---|---|---|---|
| Enemy drop | [Mudling](../enemies/mudling.md) | 60% drop chance; planned only | Live acquisition only if the enemy is live. |
...
- Recommended first implementation sink: bricks, pottery, or furnace upgrade.
